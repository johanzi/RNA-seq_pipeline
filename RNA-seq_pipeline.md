# Pipeline RNA-seq maize

Pipeline used in my [PhD thesis](https://kups.ub.uni-koeln.de/6786/) and in the paper [Oka et al., 2017](https://genomebiology.biomedcentral.com/articles/10.1186/s13059-017-1273-4).
...
### HTSeq + DESeq pipeline

HTseq is a python script performing a count of the reads
...
This experiments contains 3 biological replicates for 2 tissues (ist and husk) and 2 locations (uva and mpi).
